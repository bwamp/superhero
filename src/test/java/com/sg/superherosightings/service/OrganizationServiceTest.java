...
public class OrganizationServiceTest {
    ...
    /**
     * Test of orgByHero method, of class OrganizationService.
     */
    @Test
    public void testOrgByHero() {
        List <Organization> orgList = orgService.orgByHero("testname");
        assertEquals(1, orgList.size());
    }

    /**
     * Test of heroByOrg method, of class OrganizationService.
     */
    @Test
    public void testHeroByOrg() {
        List <Organization> orgList = orgService.heroByOrg("test org");
        assertEquals(1, orgList.size());
    }

    /**
     * Test of listAllOrg method, of class OrganizationService.
     */
    @Test
    public void testListAllOrg() {
        List <Organization> orgList = orgService.listAllOrg();
        assertEquals(1, orgList.size());
    }
    ...
    public void testUpdateOrg() {
        ...
        org.setOrganizationName("updated name");
        orgService.updateOrg(org);
        Organization testorg = orgService.selectOrg(org.getOrganizationId());
        assertEquals(org.getOrganizationId(), testorg.getOrganizationId());
        
        orgService.deleteOrg(testorg.getOrganizationId());
    }
